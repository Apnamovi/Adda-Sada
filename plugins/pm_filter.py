...
async def next_page(bot, query):
    ...
    btn.insert(0, 
        [
            InlineKeyboardButton('📝 Jᴏɪɴ Mᴏᴠɪᴇꜱ Uᴘᴅᴀᴛᴇꜱ ✅', url='https://t.me/Moviesadda24_7s')
        ]
    )
    btn.insert(1, 
         [
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('𝚂𝚄𝙿𝙿𝙾𝚁𝚃', url='https://t.me/LusiFilms'),
            InlineKeyboardButton('𝚄𝙿𝙳𝙰𝚃𝙴𝚂', url='https://t.me/Moviesadda24_7s')
            ],[
        ...
        buttons = [[
           InlineKeyboardButton('Repo', url='https://t.me/Mindsboss'),
           InlineKeyboardButton('ᴏᴡɴᴇʀ', url='https://t.me/Moviesadda24_7s)
        ], [
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='help')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
